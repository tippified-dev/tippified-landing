...
export default function CreatorTipBanner({
  ...
  if (loading) {
    return (
      <div
        className={`w-full overflow-hidden rounded-2xl border border-purple-100/80 bg-white shadow-[0_10px_35px_-20px_rgba(124,58,237,0.3)] ${className}`}
      >
  ...
  return (
    <motion.div
      ...
      className={`w-full overflow-hidden rounded-2xl border border-purple-100/80 bg-white shadow-[0_12px_40px_-20px_rgba(124,58,237,0.3)] ${className}`}
    >
      <div className="flex h-16 min-w-0 items-center gap-2.5 px-3 sm:gap-3 sm:px-4">
        ...
        <Link
          ...
          className="group flex h-9 shrink-0 items-center gap-1.5 rounded-full bg-purple-700 px-3.5 text-[11px] font-extrabold text-white shadow-md shadow-purple-200 transition-all duration-200 hover:-translate-y-0.5 hover:bg-purple-800 hover:shadow-lg active:translate-y-0 sm:px-4"
        >
          <FiZap
            size={12}
