        ...
        <div className="mx-auto max-w-7xl px-6 py-12 sm:py-16">
          ...
          <section className="mx-auto mt-16 max-w-3xl border-t border-purple-100 pt-10">
            ...
            <p className="mt-4 text-sm leading-7 text-gray-600">
              ...
              work. Whether you enjoy comedy, music, fashion, education,
              fitness, lifestyle, gaming, technology or other forms of content,
              Tippified makes it easy to support creators directly.
            </p>
