...
const steps = [
...

  {
    ...
    description:
      "After successful payment, Paystack settles the funds directly into the creator's verified bank account after platform fee is deducted .",
  },

  {
    icon: WalletIcon,
    title: "5. Creator Dashboard Updated",
    description: "Creators can see their tracked tips via their dashboards.",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="mt-16 bg-purple-700 rounded-3xl p-10 text-white">
          ...
          <p className="leading-9 mb-5 text-purple-100">
            Tippified is a creator monetization platform and{" "}
            <strong>not a fintech company</strong>. We do not process card
            payments, issue electronic money or operate as a financial
            institution.
          </p>
          ...
          <p className="leading-9 text-purple-100">
            Tippified maintains a tracked records of creator&apos; tips, which
            can be viewd on their dashboards.
          </p>
        </div>
      </div>
    </section>
