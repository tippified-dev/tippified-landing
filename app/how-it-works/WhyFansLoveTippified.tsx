...
const features = [
...

  {
    ...
    description: "Fetch your tipping history.",
  },
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="mt-6 text-lg text-gray-600 max-w-3xl mx-auto leading-8">
            Supporting your favourite creators has never been easier. Tippified
            gives fans a simple, secure and interactive way to encourage
            creators and participate in their journey.
          </p>
        </div>
        ...
        <div className="mt-20 rounded-3xl bg-purple-50 border border-purple-200 p-10">
          ...
          <p className="text-gray-700 leading-9 text-lg">
            ...
            interactions between creators and their communities through monetary
            support, virtual gifting, fundraising goals, birthday celebrations,
            wishlists and live experiences—all from one secure platform.
          </p>
        </div>
      </div>
    </section>
