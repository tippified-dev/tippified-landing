    ...
    <>
      ...
      <main className="bg-white text-gray-800 px-6 py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="mb-6">
            Rather than relying solely on advertising revenue or brand
            sponsorships, creators can receive direct financial support from
            their fans through multiple monetization tools available on
            Tippified.
          </p>
          ...
          <p className="mb-6">
            Tippified is not a bank, does not accept deposits and does not
            operate as a financial institution. We simply provide the technology
            that connects fans and creators while licensed financial
            institutions handle payment processing and settlement.
          </p>
          ...
          <p className="mb-6">
            Tippified brings together multiple creator monetization features
            inside one platform.
          </p>

          <p className="mb-6">
            While Tippified offers multiple monetization tools, creators enjoy
            all of them from one creator dashboard, making it easy to earn,
            engage supporters, and grow their community.
          </p>

          <p className="mb-6">Tippified allows creators to:</p>
          ...
          <p className="mb-6">
            Every creator receives a unique Tippified profile and personal
            tipping link that can be shared across Instagram, TikTok, YouTube,
            Facebook, X (Twitter), WhatsApp, websites, blogs and every other
            online platform where supporters can easily discover and support
            them.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-4 mb-8">
            <div className="border rounded-lg p-5">
              ...
              <p>
                Fans can instantly support creators by sending direct monetary
                tips from anywhere in the world.
              </p>
            </div>
            ...
            <div className="border rounded-lg p-5">
              ...
              <p>
                Fans can purchase virtual gifts and send them to creators as
                appreciation, celebration or encouragement.
              </p>
            </div>
            ...
            <div className="border rounded-lg p-5">
              ...
              <p>
                Creators can publish wishlists and allow fans to fulfil
            ...
            <div className="border rounded-lg p-5">
              ...
              <p>
                Creators can broadcast live while fans watch, interact, send
                monetary tips and deliver virtual gifts in real time.
              </p>
            </div>
            ...
            <div className="border rounded-lg p-5">
              ...
              <p>
                Fans can preload their Tip Wallet and Gift Wallet for instant
                gifting and tipping during live streams without payment
                interruptions.
              </p>
            </div>
          </div>
          ...
          <footer className="py-10 mt-16 border-t text-center">
            ...
            <p className="text-sm text-gray-500 mt-3">
              © {new Date().getFullYear()} Tippified. A product of Grundex
