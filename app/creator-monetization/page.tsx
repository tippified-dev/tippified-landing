        ...
        <section className="mx-auto max-w-5xl px-6 py-16 sm:px-8 lg:py-24">
          <div className="prose prose-slate max-w-none">
            ...
            <p className="mt-6 text-base leading-8 text-slate-600">
              ...
              from subscriptions, digital products, paid communities,
              memberships or direct financial support from fans.
            </p>
            ...
            <p className="mt-5 text-base leading-8 text-slate-600">
              ...
              source of income. A YouTuber can have advertising revenue while
              also receiving tips. A musician can sell music while receiving
              gifts from supporters. A fitness creator can build a community
              while receiving direct contributions toward a project.
            </p>
          ...
          <div className="mx-auto max-w-7xl px-6 py-16 sm:px-8 lg:px-10 lg:py-24">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="mt-5 text-base leading-7 text-slate-600">
                ...
                creators different ways to let fans support the work they
                already enjoy.
              </p>
            </div>
        ...
        <section className="mx-auto max-w-5xl px-6 py-16 sm:px-8 lg:py-24">
          ...
          <div className="mt-7 space-y-5 text-base leading-8 text-slate-600">
            <p>
              ...
              having an audience and earning from that audience are two
              different things.
            </p>

            <p>
              A creator can have thousands of followers and still struggle to
              turn that attention into predictable support. Advertising can
              fluctuate. Brand deals can be irregular. Algorithms can change.
              And not every creator wants to turn every piece of content into a
              product.
            </p>
          ...
          <div className="mt-10 rounded-2xl border border-purple-100 bg-purple-50 p-6 sm:p-8">
            ...
            <p className="mt-3 leading-7 text-slate-600">
              A creator can discover an audience on one platform, communicate
              with them on another and send supporters to a single Tippified
              link when they want to receive support.
            </p>
          ...
          <div className="mx-auto max-w-6xl px-6 py-16 sm:px-8 lg:py-24">
            <div className="max-w-3xl">
              ...
              <p className="mt-6 text-base leading-8 text-slate-300">
                ...
                without wanting to put that content behind a conventional
                product checkout.
              </p>
        ...
        <section className="border-y border-slate-100 bg-slate-50">
          <div className="mx-auto max-w-7xl px-6 py-16 sm:px-8 lg:px-10 lg:py-24">
            ...
            <p className="mx-auto mt-6 max-w-4xl text-sm leading-6 text-slate-500">
              ...
              documented capabilities of each platform. The platforms continue
              to evolve, and feature availability can vary by country, creator
              account and product.
            </p>
          </div>
        </section>
        ...
        <section className="mx-auto max-w-6xl px-6 py-16 sm:px-8 lg:py-24">
          <div className="grid gap-12 lg:grid-cols-[0.85fr_1.15fr] lg:items-start">
            <div>
              ...
              <p className="mt-5 text-base leading-7 text-slate-600">
                Selar is a powerful commerce platform for creators selling
                digital products, services, subscriptions and other products.
                Buy Me a Coffee combines one-time support with memberships,
                shops and publishing. Patreon focuses heavily on memberships and
                has also expanded into one-time digital commerce.
              </p>

              <p className="mt-5 text-base leading-7 text-slate-600">
                Tippified approaches the problem from a different starting
                point: <strong className="text-slate-900">fan support.</strong>
              </p>
            </div>
          ...
          <div className="mx-auto max-w-6xl px-6 py-16 sm:px-8 lg:py-24">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="mt-5 text-base leading-8 text-purple-100">
                ...
                payment and banking partners rather than Tippified operating as
        ...
        <section className="border-t border-slate-100 bg-white">
          <div className="mx-auto max-w-4xl px-6 py-20 text-center sm:px-8">
            ...
            <p className="mx-auto mt-5 max-w-2xl text-base leading-8 text-slate-600 sm:text-lg">
              Give the people who enjoy your work a simple way to support what
              you create. Start building a direct relationship between your
              content and your creator income.
            </p>
